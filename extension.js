...
function activate(context) {
	console.log('"hbuilder-cli" 插件激活了,我要干大事了!');

	// 命令已在package.json文件中定义
	// 现在用registerCommand提供命令的实现
	// commandId参数必须与package.json中的command字段匹配 
	let disposableOpenHBuilder = vscode.commands.registerCommand('hbuilder-cli.openHBuilder', commands.OpenHBuilder);

	let disposableBuildApp = vscode.commands.registerCommand('hbuilder-cli.buildApp', commands.buildApp)
